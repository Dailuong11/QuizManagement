...
namespace QuizManagement.Teacher
{
    public partial class UpdateQuestion : UserControl
    {
        ...
        private void comboSet_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            query = "select qNo from questions where qser = '" + comboSet.Text + "'";
            DataSet ds = fn.getData(query);
        ...
        {
            query = "select question,optionA,optionB,optionC,optionD,ans from questions where qser = '" + comboSet.Text + "'and qNo = '" + comboQuestion.Text + "'";
            DataSet ds = fn.getData(query);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (comboQuestion.SelectedIndex != -1)
            {
                ...
                query = "update questions set question='" + question + "',optionA = '" + option1 + "',optionB = '"+option2+"',optionC = '"+option3+"',optionD = '"+option4+"',ans = '"+answer+"'where qser = '"+qset+"'and qNo = '"+qNo+"'";
